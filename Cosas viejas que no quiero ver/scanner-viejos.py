...
#        factors = np.array([i for i in convFactors.values()])[:, np.newaxis] 
        #Esta linea generaba un vector con 3 componentesque en cada corrida se acomodan distinto 
        #es culpa del diccionario, lo escribo distinto (linea 146 se va--> 149 entra)
        factors=np.array([convFactors['x'],convFactors['y'],convFactors['z']])[:, np.newaxis] 
