...
# arma los barridos con los parametros dados
        ...
        self.barridox = np.linspace(startX, sizeX,
                                 self.numberofPixels) / convFactors['x']
        self.barridoxvuelta = np.flip(self.barridox, axis=0)

        #       Barrido y
        startY = float(self.initialPosition[1])
        self.barridoy = np.ones(self.numberofPixels)*startY / convFactors['y']
...
#                source=r'100kHzTimeBase',
                ...
                samps_per_chan=self.numberofPixels)
