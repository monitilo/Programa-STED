...
#                               translateSnap=True)
    ...
    def paramChanged(self):
        ...
        self.Napd = 1  # int(np.round(self.apdrate * self.pixelTime))
...
#APDtodo = barridox
#
#        contando = np.zeros((len(self.APDtodo)))
#        s=0
#        for j in range(Npix):
#        #    l = (j*Npix)-1
#            l=s
...
#                source=r'100kHzTimeBase',
    ...
    #                                trigger_edge = nidaqmx.constants.Edge.RISING)
            ...
            self.citask.triggers.arm_start_trigger.dig_edge_src = "PFI4"
